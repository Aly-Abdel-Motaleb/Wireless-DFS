...
const (
	...
	MasterTracker_DoesFileExist_FullMethodName    = "/dfs.masterTracker/DoesFileExist"
)
...
type MasterTrackerClient interface {
	...
	DoesFileExist(ctx context.Context, in *DownloadRequest, opts ...grpc.CallOption) (*Ack, error)
}
...
func (c *masterTrackerClient) DoesFileExist(ctx context.Context, in *DownloadRequest, opts ...grpc.CallOption) (*Ack, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Ack)
	err := c.cc.Invoke(ctx, MasterTracker_DoesFileExist_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MasterTrackerServer interface {
	...
	DoesFileExist(context.Context, *DownloadRequest) (*Ack, error)
...
func (UnimplementedMasterTrackerServer) DoesFileExist(context.Context, *DownloadRequest) (*Ack, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DoesFileExist not implemented")
}
...
func _MasterTracker_DoesFileExist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DownloadRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MasterTrackerServer).DoesFileExist(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MasterTracker_DoesFileExist_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MasterTrackerServer).DoesFileExist(ctx, req.(*DownloadRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MasterTracker_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _MasterTracker_DoesFileExist_Handler,
		},
	},
...
type DataKeeperClient interface {
	...
	RequestUpload(ctx context.Context, in *DataKeeperUploadRequest, opts ...grpc.CallOption) (*UploadResponse, error)
...
func (c *dataKeeperClient) RequestUpload(ctx context.Context, in *DataKeeperUploadRequest, opts ...grpc.CallOption) (*UploadResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UploadResponse)
...
func (c *dataKeeperClient) RequestDownload(ctx context.Context, in *DownloadRequest, opts ...grpc.CallOption) (*DataKeeperDownloadResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DataKeeperDownloadResponse)
	err := c.cc.Invoke(ctx, DataKeeper_RequestDownload_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DataKeeperServer interface {
	...
	RequestUpload(context.Context, *DataKeeperUploadRequest) (*UploadResponse, error)
...
func (UnimplementedDataKeeperServer) RequestUpload(context.Context, *DataKeeperUploadRequest) (*UploadResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RequestUpload not implemented")
}
...
func _DataKeeper_RequestUpload_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DataKeeperUploadRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataKeeperServer).RequestUpload(ctx, req.(*DataKeeperUploadRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _DataKeeper_RequestDownload_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DownloadRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DataKeeperServer).RequestDownload(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DataKeeper_RequestDownload_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataKeeperServer).RequestDownload(ctx, req.(*DownloadRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DataKeeper_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "requestDownload",
			Handler:    _DataKeeper_RequestDownload_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "dfs.proto",
